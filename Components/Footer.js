      ...
      <section className="footer-main">
        ...
        <div className="footer-inner">
          ...
          <div>
            ...
            <Link href="https://instagram.com/zebdermm?igshid=ZDdkNTZiNTM=" target="_blank"><img src="./images/Instagram.png" height="55px" width="55px" style={{ marginLeft: "1rem" }} /></Link>
